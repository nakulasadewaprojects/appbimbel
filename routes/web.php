...
Route::post('/quiz/input', 'HomeController@inputQuiz');
...
Route::get('/reviewMentor', 'HomeSiswaController@reviewMentor');
Route::post('/reviewMentor/input', 'HomeSiswaController@inputReviewMentor'); 
