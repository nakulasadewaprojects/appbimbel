...
@if($paket->hari!=NULL && $paket->wkt_mulai!=NULL)
								...
								<div class="form-group m-form__group row">
										...
										<div class="col-lg-6">
												<div class="input-group m-input-group m-input-group--square">
														...
														<input type="text" readonly class="form-control m-input" name="namaPaket" value="{{$paket->nmpaket}}">
													</div>
										</div>
								</div>
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-6">
											<div class="input-group m-input-group m-input-group--square">
													...
													<input type="text" readonly class="form-control m-input" name="hargaPaket" value="{{$paket->harga}}">
												</div>
									</div>
								</div>
								<div class="form-group m-form__group row">
							...
							<div class="m-form__section m-form__section--last">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-6 col-md-9 col-sm-12">
											...
											<input readonly type="text" class="form-control m-input" name="durasi" value="{{$paket->durasi}}">
										</div>
								</div>
								<div class="form-group m-form__group row">
									<label class="col-lg-2 col-form-label">
										...
										<div class="col-lg-6 col-md-9 col-sm-12">
											...
											<input readonly type="text" class="form-control m-input" name="hari" value="{{$paket->hari}}">											
										</div>
								</div>
								<div class="form-group m-form__group row">
									<label class="col-lg-2 col-form-label">
										...
										<div class="col-lg-6 col-md-9 col-sm-12">
											<div class='input-group timepicker'  >
												...
												<input readonly type="text" class="form-control m-input" name="waktuMulai" value="{{$paket->wkt_mulai}}">											
												<span class="input-group-addon">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-6 col-md-9 col-sm-12">
										<div class='input-group timepicker' >
											...
											<input readonly type="text" class="form-control m-input" name="waktuSelesai" value="{{$paket->wkt_akhir}}">																				
											<span class="input-group-addon">
												<i class="la la-clock-o"></i>
											</span>
										</div>
								...
								<div class="form-group m-form__group row">
										...
										<div class="col-lg-6 col-md-9 col-sm-12">
											...
											<input readonly type="text" class="form-control m-input" name="prodi" value="{{$paket->matpel}}">																				
												<span class="m-form__help">
...
@elseif($paket->hari!=NULL && $paket->wkt_mulai==NULL)
<div class="m-grid__item m-grid__item--fluid m-wrapper">
