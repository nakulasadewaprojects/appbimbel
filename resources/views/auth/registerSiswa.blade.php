...
<!--                            <div class="col-md-6">-->
                                <input id="NamaLengkap" type="text" placeholder="Nama Lengkap" class="form-control{{ $errors->has('NamaLengkap') ? ' is-invalid' : '' }}" name="NamaLengkap"
                                    value="{{ old('NamaLengkap') }}" required autofocus> @if ($errors->has('NamaLengkap'))
                                <span class="invalid-feedback" role="alert">
...
<!--                            <div class="col-md-6">-->
                                <input id="NoTlpn" type="tel" placeholder="Nomor Telepon" class="form-control{{ $errors->has('NoTlpn') ? ' is-invalid' : '' }}" name="NoTlpn" value="{{ old('NoTlpn') }}"
                                    required> @if ($errors->has('NoTlpn'))
                                <span class="invalid-feedback" role="alert">
